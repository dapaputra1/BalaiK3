...
@section('seo_title', 'Jejaring Universitas Balai K3 Surabaya')
@section('seo_description', 'Daftar jejaring universitas Balai K3 Surabaya yang memuat nama universitas, alamat, dan tautan website resmi.')
@section('seo_keywords', 'jejaring universitas, universitas mitra, Balai K3 Surabaya, website universitas')
@section('seo_json_ld')
@php echo json_encode([
    '@context' => 'https://schema.org',
    '@type' => 'CollectionPage',
    'name' => 'Jejaring Universitas Balai K3 Surabaya',
    'url' => route('jejaring.universitas'),
    'description' => 'Daftar jejaring universitas Balai K3 Surabaya.',
...
<style>
    ...
    .network-hero {
        ...
        background:
            linear-gradient(135deg, rgba(17, 61, 99, 0.96) 0%, rgba(30, 88, 138, 0.92) 52%, rgba(77, 150, 126, 0.84) 100%);
    }
    ...
    .network-badge {
        ...
        padding: 10px 16px;
        border-radius: 999px;
        background: rgba(57, 182, 143, 0.14);
        color: #1d5a4c;
        font-size: 12px;
        font-weight: 700;
    }
    ...
    <section class="network-hero">
        <div class="network-shell network-hero-inner">
            <p class="network-breadcrumb">
                <a href="{{ route('home') }}">Beranda</a> / <span>Jejaring Universitas</span>
            </p>
            <h1 class="network-title">Jejaring Universitas</h1>
            <p class="network-lead">
                Informasi pada halaman ini memuat daftar universitas yang menjadi bagian dari jejaring Balai K3 Surabaya.
            </p>
        </div>
    </section>
        ...
        <div class="network-shell">
            <div class="network-card">
                <div class="network-card-head">
                    <div>
                        <h2 class="network-card-title">Data Universitas</h2>
                    </div>
                </div>
                ...
                <div class="network-table-wrap">
                    <div class="table-responsive network-table-shell">
                        <table class="table network-table align-middle">
                            <thead>
                                <tr>
                                    <th style="width: 32%;">Nama Universitas</th>
                                    <th>Alamat</th>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="network-empty">
                                            <strong>Data universitas belum tersedia.</strong>
                                            Tambahkan daftar universitas pada controller agar tabel ini langsung menampilkan data.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
