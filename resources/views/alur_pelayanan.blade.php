...
<div class="alur-page">
    <section class="alur-hero">
        <div class="alur-hero-inner">
            <div class="alur-hero-copy">
                <p class="alur-breadcrumb"><a href="{{ route('home') }}">Beranda</a> / Alur Pelayanan</p>
                <h1 class="alur-title">ALUR PELAYANAN</h1>
                <div class="alur-title-line"></div>
            </div>
        </div>
        <div class="alur-hero-ribbon"></div>
        <div class="alur-hero-ribbon is-back"></div>
    </section>

    <section class="alur-content">
        <div class="alur-card">
            <img src="{{ asset('images/alurpelayanan.jpg') }}" alt="Alur Pelayanan Balai K3 Surabaya">
        </div>
    </section>
</div>
@endsection
