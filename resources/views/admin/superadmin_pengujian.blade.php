...
<style>
  ...
  #pengujianAccordion [data-doc-add],
  #pengujianAccordion [data-add-row],
  #pengujianAccordion [data-add-direct-doc],
  #pengujianAccordion [data-upload-add],
  #pengujianAccordion [data-upload-camera],
  #pengujianAccordion [data-param-add],
  #pengujianAccordion [data-direct-param-add] {
    background-color: #0f2f53 !important;
    border-color: #0f2f53 !important;
    color: #fff !important;
  }
  #pengujianAccordion [data-doc-add] i,
  #pengujianAccordion [data-add-row] i,
  #pengujianAccordion [data-add-direct-doc] i,
  #pengujianAccordion [data-upload-add] i,
  #pengujianAccordion [data-upload-camera] i,
  #pengujianAccordion [data-param-add] i,
  #pengujianAccordion [data-direct-param-add] i {
    color: #fff !important;
  }
  #pengujianAccordion [data-doc-add]:hover,
  #pengujianAccordion [data-doc-add]:focus,
  #pengujianAccordion [data-add-row]:hover,
  #pengujianAccordion [data-add-row]:focus,
  #pengujianAccordion [data-add-direct-doc]:hover,
  #pengujianAccordion [data-add-direct-doc]:focus,
  #pengujianAccordion [data-upload-add]:hover,
  #pengujianAccordion [data-upload-add]:focus,
  #pengujianAccordion [data-upload-camera]:hover,
  #pengujianAccordion [data-upload-camera]:focus,
  #pengujianAccordion [data-param-add]:hover,
  #pengujianAccordion [data-param-add]:focus,
  #pengujianAccordion [data-direct-param-add]:hover,
  #pengujianAccordion [data-direct-param-add]:focus {
    background-color: #0b2340 !important;
    border-color: #0b2340 !important;
    color: #fff !important;
  ...
  .table-direct [data-direct-method-head],
  .table-direct [data-direct-method-cell] {
    display: none !important;
  }
  #pengujianAccordion .table-indirect th:nth-child(1),
  #pengujianAccordion .table-indirect td:nth-child(1) { width: 5%; }
  #pengujianAccordion .table-indirect th:nth-child(2),
  #pengujianAccordion .table-indirect td:nth-child(2) { width: 14%; }
  #pengujianAccordion .table-indirect th:nth-child(3),
  #pengujianAccordion .table-indirect td:nth-child(3) { width: 17%; }
  #pengujianAccordion .table-indirect th:nth-child(4),
  #pengujianAccordion .table-indirect td:nth-child(4) { width: 17%; }
  #pengujianAccordion .table-indirect th:nth-child(8),
  #pengujianAccordion .table-indirect td:nth-child(8) { width: 7%; }
  ...
  #pengujianAccordion [data-action-save],
  #pengujianAccordion [data-action-submit] {
    padding: 0.42rem 0.78rem;
    font-size: 10.75px;
  }
  #pengujianAccordion [data-direct-param-cell] .btn.btn-sm.mt-2,
  #pengujianAccordion [data-param-docs] .btn.btn-sm.mt-2,
  #pengujianAccordion [data-doc-add].btn.btn-sm {
    width: auto;
    min-height: 24px;
  ...
  <div class="card-body">
    ...
    @if($revisionOnly)
      <div class="d-flex flex-wrap gap-2 mt-3">
        <button type="button" class="btn btn-outline-primary btn-sm active" data-pcu-stage-filter="revisi">Revisi</button>
        <button type="button" class="btn btn-outline-primary btn-sm" data-pcu-stage-filter="sesuai">Sesuai</button>
      </div>
    @endif
  </div>
</div>
...
<div class="accordion" id="pengujianAccordion">
  ...
  @php
    ...
    $scheduleNote = trim((string) data_get($order, 'detail.catatan_sampling', ''));
  @endphp
  <div
    ...
    data-return-url="{{ $permohonanId ? route($routePrefix . '.pengujian.return-to-penjadwalan', $permohonanId, false) : '' }}"
    data-save-url="{{ (!$readyForBap && $permohonanId) ? route($routePrefix . '.pengujian.draft', $permohonanId, false) : '' }}"
    data-submit-url="{{ $permohonanId ? ($readyForBap ? route($routePrefix . '.pengujian.forward-bap', $permohonanId, false) : route($routePrefix . '.pengujian.submit', $permohonanId, false)) : '' }}"
  >
    <h2 class="accordion-header" id="{{ $accordionHeadingId }}">
      ...
      >
        <div class="d-flex flex-nowrap w-100 align-items-center pe-3 gap-2">
          <div>
            <div>{{ $order['kode'] }}</div>
            <div class="small text-muted fw-normal">{{ $order['perusahaan'] }}</div>
          </div>
    ...
    >
      <div class="accordion-body bg-white" data-order-card>
        <div class="d-flex justify-content-between align-items-start mb-3 flex-wrap gap-2">
          <div class="small text-muted">Catatan penjadwalan: {{ $scheduleNote !== '' && $scheduleNote !== '-' ? $scheduleNote : '-' }}</div>
          <div class="d-flex gap-2 flex-wrap">
            ...
            @endif
            <button class="btn btn-outline-danger btn-sm" type="button" data-action-return-schedule>Kembalikan ke Penjadwalan</button>
            @if($sptUrl)
            ...
            @endif
            <button class="btn btn-outline-primary btn-sm" type="button" data-parameter-summary-open>
              <i class="bi bi-list-check"></i> Lihat Ringkasan Parameter
            </button>
            @unless($readyForBap)
          ...
          <table class="table table-sm align-middle mb-0 table-direct">
            <thead class="table-light">
              <tr>
                ...
                <th style="width: 17%;">Parameter</th>
                <th style="width: 9%;" data-direct-method-head>Metode</th>
                <th style="width: 15%;">
                  <div class="d-flex align-items-center gap-2">
                    <span>Lokasi</span>
                  </div>
        ...
        <div class="d-flex justify-content-end align-items-center mt-3 gap-2">
          ...
          <button class="btn btn-primary btn-sm" type="button" data-action-submit>
            {{ $readyForBap ? 'Lanjutkan Buat BAP' : (!empty($order['has_revision']) ? 'Kirim Ulang Setelah Revisi' : 'Kirim ke BAP') }}
          </button>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="parameterSummaryModal" tabindex="-1" aria-labelledby="parameterSummaryModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <div>
          <h6 class="modal-title mb-1" id="parameterSummaryModalLabel">Ringkasan Parameter Pengujian</h6>
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
      </div>
      <div class="modal-body">
        <div class="row g-3 mb-3">
          <div class="col-12 col-md-6">
            <div class="parameter-summary-meta">
              <div class="parameter-summary-meta-label">Kode Permohonan</div>
              <div class="parameter-summary-meta-value" data-parameter-summary-kode>-</div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="parameter-summary-meta">
              <div class="parameter-summary-meta-label">Perusahaan</div>
              <div class="parameter-summary-meta-value" data-parameter-summary-perusahaan>-</div>
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table class="table table-sm align-middle mb-0">
            ...
            <tbody data-parameter-summary-body></tbody>
          </table>
        </div>
      </div>
      <div class="modal-footer">
...
(() => {
  ...
  const parameterSummaryModalEl = document.getElementById('parameterSummaryModal');
  const parameterSummaryModal = parameterSummaryModalEl && window.bootstrap ? new window.bootstrap.Modal(parameterSummaryModalEl) : null;
  ...
  document.querySelectorAll('[data-parameter-summary-open]').forEach((btn) => {
    btn.addEventListener('click', () => {
      const card = btn.closest('[data-card]');
      if (!card || !parameterSummaryModalEl) return;

      const detail = parseCardJson(card, 'data-detail', {}) || {};
      const params = Array.isArray(detail.parameter) ? detail.parameter : [];
      const tbody = parameterSummaryModalEl.querySelector('[data-parameter-summary-body]');

      parameterSummaryModalEl.querySelector('[data-parameter-summary-kode]').textContent = detail.kode || '-';
      parameterSummaryModalEl.querySelector('[data-parameter-summary-perusahaan]').textContent = detail.perusahaan || '-';

      if (tbody) {
        if (!params.length) {
          tbody.innerHTML = '<tr><td colspan="3" class="text-muted text-center py-3">Belum ada parameter yang disetujui.</td></tr>';
        } else {
          tbody.innerHTML = params.map((row, index) => `
            <tr>
              <td>${index + 1}</td>
              <td>${row.name || '-'}</td>
              <td>${row.qty || 0}</td>
...
(() => {
  ...
  const inferParamTableType = (param) => {
    const categoryText = [
      param?.category,
      param?.category_name,
      param?.category_short_code,
      param?.categoryCode,
    ]
    ...
    const nameText = String(param?.name || '').trim().toLowerCase();
    const shortCode = String(param?.short_code || '').trim().toLowerCase();
    const haystack = `${nameText} ${shortCode} ${categoryText}`.trim();
    if (!haystack) return '';

    const fisikaKeywords = [
      'getaran',
      'kebisingan',
      'noise',
      'dosimeter',
    ...
    if (fisikaKeywords.some((keyword) => haystack.includes(keyword))) {
      return 'direct';
    }
    if (kimiaKeywords.some((keyword) => haystack.includes(keyword))) {
      return 'indirect';
    }

    // Ambien/Emisi umumnya parameter kimia pada alur pengujian ini.
    if (categoryText.includes('amb') || categoryText.includes('ems') || categoryText.includes('emisi') || categoryText.includes('ambien')) {
      return 'indirect';
    }
  ...
  const filterParamsByTableType = (params, tableType) => {
    const list = Array.isArray(params) ? params : [];
    if (tableType === 'direct') {
      return list.filter((param) => inferParamTableType(param) === 'direct');
    }
    if (tableType === 'indirect') {
      return list.filter((param) => inferParamTableType(param) === 'indirect');
    }
    return list;
  };

  const getFilteredExtraCategories = (tableType = '') => {
    const normalizedTableType = String(tableType || '').toLowerCase();
    if (!extraCategories.length) return [];
    if (!['direct', 'indirect'].includes(normalizedTableType)) {
      return extraCategories;
    }

    return extraCategories
      .map((category) => {
        const categoryLabel = category?.short_code || category?.name || '';
        const params = Array.isArray(category?.parameters) ? category.parameters : [];
        const filteredParams = params.filter((param) => {
          const inferred = inferParamTableType({
            ...param,
            category: categoryLabel,
          });
          return inferred === normalizedTableType;
        });
  ...
  const getParamOptions = (categoryId, categories = []) => {
  ...
  const openExtraModal = (select) => {
    ...
    const tableType = select?.closest('[data-table-wrap]')?.getAttribute('data-table-wrap') || '';
    pendingExtraCategories = getFilteredExtraCategories(tableType);

    extraCategorySelect.innerHTML = getCategoryOptions(pendingExtraCategories);
    const selectedCategory = extraCategorySelect.value;
    extraParamSelect.innerHTML = getParamOptions(selectedCategory, pendingExtraCategories);
    extraModal.show();
  };

  if (extraCategorySelect && extraParamSelect) {
    extraCategorySelect.addEventListener('change', () => {
      extraParamSelect.innerHTML = getParamOptions(extraCategorySelect.value, pendingExtraCategories);
    });
  }
  ...
  const updateParamOptions = (contextEl) => {
    ...
    selects.forEach((select) => {
      ...
      if (
        ...
        String(customValue || '') === String(currentValue) &&
  ...
  const createReviewSwitch = (rowId, state = '') => {
    const wrap = createReqSwitch(rowId);
  ...
  const createReviewNote = (rowId, note = '') => {
    ...
    if (value) {
      ...
      wrap.textContent = 'Tidak ada catatan';
  ...
  const hasUploadRowFile = (row) => {
    const input = row?.querySelector('input[type="file"]');
    if (!input) return false;
    const files = Array.from(input.files || getStoredInputFiles(input));
  ...
  const createExistingFileRow = (docItem, file) => {
    ...
    removeBtn?.addEventListener('click', async () => {
      const ok = await confirmAction('File pada baris ini sudah diupload. Yakin ingin menghapusnya?');
      if (!ok) return;
  ...
  const createDocItem = (docId, label, options = {}) => {
    const { withInitialRow = true, allowRemove = false } = options;
    ...
    docItem.innerHTML = `
      <div class="doc-header">
        ...
        ${allowRemove ? `
          <button class="btn btn-sm doc-remove-btn d-none" type="button" data-doc-remove aria-label="Hapus dokumen" title="Hapus dokumen">
  ...
  const setupRow = (row, params, tbody, tableType) => {
    ...
    const renumberDocs = () => {
      const items = Array.from(docList.querySelectorAll('[data-doc-item]'));
      const canRemoveDoc = items.length > 1;
      items.forEach((item, index) => {
        ...
        if (removeBtn) {
          removeBtn.classList.toggle('d-none', !canRemoveDoc);
        }
      });
    };
    ...
    const addParamRowToDoc = (docId, values = {}) => {
      ...
      const updateSuitability = (value) => {
        ...
        if (isAllowed) {
          ...
          const totalSelectedQty = usedByOthers + normalizedCurrentQty;
          isAllowed = normalizedCurrentQty <= remainingQty
            && Number.isFinite(totalAllowedQty)
            && totalSelectedQty === totalAllowedQty;
        }
        switchInput.checked = !!isAllowed;
        switchInput.classList.toggle('req-switch-invalid', !isAllowed);
      };
      select.__refreshSuitability = () => updateSuitability(select.value);
      ...
      removeBtn.addEventListener('click', () => {
        ...
        setDocEmpty();
        updateParamOptions(paramDocBlock);
        requestAnimationFrame(syncDocHeights);
      });
    ...
    const addDoc = (preset = {}) => {
      ...
      const getDocTotalFiles = () => {
        const selectedFiles = Array.from(uploadWrap?.querySelectorAll('input[type="file"]') || [])
          .reduce((total, fileInput) => total + Array.from(fileInput.files || getStoredInputFiles(fileInput)).length, 0);
        const existingFiles = docItem.querySelectorAll('[data-existing-file-row]').length;
        return selectedFiles + existingFiles;
      };
      const ensureUploadRowExists = () => {
        if (!uploadWrap) return;
        const hasUploadRow = uploadWrap.querySelector('[data-upload-row]');
        if (hasUploadRow) return;
        const rowNew = createUploadRow({ required: true });
        uploadWrap.insertBefore(rowNew, uploadAdd?.parentElement || uploadWrap.firstChild);
      };
      const clearDocParams = () => {
        const currentParamDocBlock = paramDocs.querySelector(`[data-doc-id="${docKey}"]`);
        if (!currentParamDocBlock) return;
        const paramRows = Array.from(currentParamDocBlock.querySelectorAll('[data-param-row-id]'));
        paramRows.forEach((paramRow) => {
          const rowId = paramRow.dataset.paramRowId;
          paramRow.remove();
          methodDocs.querySelector(`[data-doc-id="${docKey}"] [data-param-row-id="${rowId}"]`)?.remove();
          qtyDocs.querySelector(`[data-doc-id="${docKey}"] [data-param-row-id="${rowId}"]`)?.remove();
          actionDocs.querySelector(`[data-doc-id="${docKey}"] [data-param-row-id="${rowId}"]`)?.remove();
          switchDocs.querySelector(`[data-doc-id="${docKey}"] [data-param-row-id="${rowId}"]`)?.remove();
          reviewDocs?.querySelector(`[data-doc-id="${docKey}"] [data-param-row-id="${rowId}"]`)?.remove();
          noteDocs?.querySelector(`[data-doc-id="${docKey}"] [data-param-row-id="${rowId}"]`)?.remove();
        });
        setDocEmpty();
        updateParamOptions(currentParamDocBlock);
      };
      const normalizeDocAfterFileRemoval = () => {
        if (getDocTotalFiles() > 0) return;
        clearDocParams();
        ensureUploadRowExists();
        requestAnimationFrame(syncDocHeights);
      };
      ...
      if (uploadAdd && uploadWrap) {
        uploadWrap.addEventListener('click', async (event) => {
          ...
          const rows = uploadWrap.querySelectorAll('[data-upload-row]');
          const input = row.querySelector('input[type="file"]');
          const selectedFiles = Array.from(input?.files || getStoredInputFiles(input));
          const hasSelectedFile = selectedFiles.length > 0;
          const hasExistingFile = docItem.querySelectorAll('[data-existing-file-row]').length > 0;
          ...
          if (rows.length <= 1 && !hasSelectedFile && !hasExistingFile) {
            const docRemoveBtn = docItem.querySelector('[data-doc-remove]');
            if (docRemoveBtn && !docRemoveBtn.classList.contains('d-none')) {
              docRemoveBtn.click();
              return;
            }
          }
      ...
      if (uploadCamera && uploadWrap) {
        uploadCamera.addEventListener('click', async () => {
          ...
          await openCameraCapture({
            input,
            row,
            onComplete: () => requestAnimationFrame(syncDocHeights),
            onCancel: () => requestAnimationFrame(syncDocHeights),
          });
          requestAnimationFrame(syncDocHeights);
        });
      }
  ...
  const createDirectDocRow = (index, params, preset = {}) => {
    ...
    addParameterBtn.setAttribute('data-direct-param-add', 'true');
    ...
    const addParameterGroupRow = (paramPreset = {}) => {
      ...
      if (IS_REVISION_VIEW) {
        ...
        noteBlock.innerHTML = '<div class="doc-label">Catatan</div>';
      ...
      select.__refreshSuitability = () => updateDirectSuitability(select.value);
  ...
  window.Pengujian.addRow = (btn) => {
    ...
    const filteredParams = filterParamsByTableType(params, tableType);
    const nextIndex = tbody.querySelectorAll('[data-row]').length + 1;
    tbody.insertAdjacentHTML('beforeend', buildRow(filteredParams, nextIndex));
    const rows = tbody.querySelectorAll('[data-row]');
    const newRow = rows[rows.length - 1];
    setupRow(newRow, filteredParams, tbody, tableType);
    updateRowIndexes(tbody);
  };
  window.Pengujian.addDocFromHeader = (btn) => {
    ...
    if (row.dataset.rowInit !== 'true') {
      ...
      const tableType = tbody.dataset.tableType || 'indirect';
      const filteredParams = filterParamsByTableType(params, tableType);
      setupRow(row, filteredParams, tbody, tableType);
    }
    row.__addDoc?.();
  };
  ...
  document.querySelectorAll('[data-card]').forEach((card) => {
    ...
    const returnBtn = card.querySelector('[data-action-return-schedule]');
    ...
    const syncSubmitState = () => {
      ...
      const ready = hasTable && paramsComplete && docsComplete && requiredUploadsComplete && !directIssue;
    ...
    const lockReadyForBapCard = () => {
      ...
      orderCard.querySelectorAll('input, select, textarea, button').forEach((el) => {
        if (el.matches('[data-action-submit], [data-action-return-schedule]')) return;
        el.disabled = true;
      });
    };
    ...
    const initTableRows = (tbody) => {
      ...
      const filteredParams = filterParamsByTableType(params, tableType);
      tbody.querySelectorAll('[data-row]').forEach((row) => setupRow(row, filteredParams, tbody, tableType));
    };
    ...
    const hasMeaningfulTableData = (wrap) => {
      if (!wrap) return false;
      const hasSelectedParam = Array.from(wrap.querySelectorAll('select[data-param-select]'))
        .some((select) => {
          const value = String(select.value || '').trim();
          return value !== '' && value !== EXTRA_OPTION;
        });
      if (hasSelectedParam) return true;

      const hasUploadedFile = Array.from(wrap.querySelectorAll('input[type="file"]'))
        .some((input) => Array.from(input.files || getStoredInputFiles(input)).length > 0);
      if (hasUploadedFile) return true;

      const hasExistingFile = wrap.querySelectorAll('[data-existing-file-row]').length > 0;
      return hasExistingFile;
    };

    const resetTableData = (type) => {
      const wrap = card.querySelector(`[data-table-wrap="${type}"]`);
      const tbody = wrap?.querySelector('[data-order-table]');
      if (!wrap || !tbody) return;

      Array.from(wrap.querySelectorAll('[data-doc-item]')).forEach((docItem) => {
        cleanupDocPreviewUrls(docItem);
      });
      ...
      const indirectParams = filterParamsByTableType(params, 'indirect');
      tbody.innerHTML = buildRow(indirectParams, 1);
      const row = tbody.querySelector('[data-row]');
      if (row) {
        setupRow(row, indirectParams, tbody, 'indirect');
      }
      updateRowIndexes(tbody);
    };
    ...
    tableWraps.forEach((wrap) => {
      ...
      if (tableType !== 'direct') {
        const filteredParams = filterParamsByTableType(params, tableType);
        const hasExisting = applyExistingData(card, filteredParams, tbody, tableType);
        if (hasExisting) {
          wrap.classList.remove('d-none');
        ...
        if (existing?.lokasi?.length) {
          ...
          if (groups.length) {
            ...
            groups.forEach((group, idx) => {
              const directParams = filterParamsByTableType(params, 'direct');
              const row = createDirectDocRow(idx + 1, directParams, group);
    ...
    // Auto tampilkan tabel sesuai jenis parameter pada order:
    // - Jika ada parameter direct -> tampilkan tabel direct.
    // - Jika ada parameter indirect -> tampilkan tabel indirect.
    // - Jika keduanya ada -> tampilkan dua tabel sekaligus.
    const hasDirectParams = filterParamsByTableType(params, 'direct').length > 0;
    const hasIndirectParams = filterParamsByTableType(params, 'indirect').length > 0;

    if (hasDirectParams) {
      const directWrap = card.querySelector('[data-table-wrap="direct"]');
      if (directWrap) {
        directWrap.classList.remove('d-none');
        const directAddBtn = card.querySelector('[data-add-table="direct"]');
        if (directAddBtn) directAddBtn.classList.add('d-none');
      }
    }

    if (hasIndirectParams) {
      const indirectWrap = card.querySelector('[data-table-wrap="indirect"]');
      if (indirectWrap) {
        indirectWrap.classList.remove('d-none');
        const indirectAddBtn = card.querySelector('[data-add-table="indirect"]');
        if (indirectAddBtn) indirectAddBtn.classList.add('d-none');
      }
    }
    ...
    card.querySelectorAll('[data-add-direct-doc]').forEach((btn) => {
      btn.addEventListener('click', () => {
        ...
        const directParams = filterParamsByTableType(params, 'direct');
        const row = createDirectDocRow(nextIndex, directParams);
        tbody.appendChild(row);
        row.__initLocations?.();
        const addBtn = card.querySelector('[data-add-table="direct"]');
    ...
    removeTableButtons.forEach((btn) => {
      btn.addEventListener('click', async () => {
        ...
        const wrap = card.querySelector(`[data-table-wrap="${type}"]`);
        if (!wrap) return;
        if (hasMeaningfulTableData(wrap)) {
          const ok = await confirmAction('Data pada tabel ini sudah diisi/upload. Yakin ingin menghapus tabel?');
          if (!ok) return;
        }
        resetTableData(type);
      ...
      const scheduleSubmitSync = () => {
        requestAnimationFrame(() => {
          updateParamOptions(card);
          Array.from(card.querySelectorAll('select[data-param-select]')).forEach((select) => {
            if (typeof select.__refreshSuitability === 'function') {
              select.__refreshSuitability();
            }
          });
          syncSubmitState();
        });
    ...
    const returnUrl = card.getAttribute('data-return-url') || '';
    ...
    if (submitBtn && submitUrl) {
      submitBtn.addEventListener('click', async () => {
        ...
        if (!hasVisibleTable()) {
          await notify('error', `Tambah tabel terlebih dahulu sebelum ${hasRevision ? 'kirim ulang ke verifikasi pengujian' : 'mengirim ke BAP'}.`);
          return;
        }
        if (!hasFilledParams()) {
          await notify('error', `Isi minimal satu parameter sebelum ${hasRevision ? 'kirim ulang ke verifikasi pengujian' : 'mengirim ke BAP'}.`);
          return;
        }
        ...
        try {
          ...
          const data = await sendPayload(card, submitUrl);
          await notify('success', data.message || (hasRevision ? 'Perbaikan pengujian berhasil dikirim ulang ke verifikasi pengujian.' : 'Pengujian berhasil dikirim ke BAP.'));
          ...
          await notify('error', error.message || (hasRevision ? 'Gagal mengirim ulang perbaikan ke verifikasi pengujian.' : 'Gagal mengirim ke BAP.'));
        } finally {
          setCardLoading(card, false);
        }
      });
    ...
    if (returnBtn && returnUrl) {
      returnBtn.addEventListener('click', async () => {
        ...
        if (window.Swal) {
          ...
          reason = (window.prompt('Masukkan alasan dikembalikan ke penjadwalan:') || '').trim();
          if (!reason) return;
        }

        try {
          setCardLoading(card, true, returnBtn);
          const formData = new FormData();
          ...
          const data = await response.json().catch(() => ({}));
          if (!response.ok) {
            throw new Error(data.message || 'Gagal mengembalikan ke penjadwalan.');
          }
          await notify('success', data.message || 'Permohonan berhasil dikembalikan ke penjadwalan.');
          window.location.reload();
        } catch (error) {
          await notify('error', error.message || 'Gagal mengembalikan ke penjadwalan.');
        } finally {
          setCardLoading(card, false);
        }
      });
