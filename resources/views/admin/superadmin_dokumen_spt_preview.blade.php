@php
  ...
  $logoSrc = $logoDataUri ?? asset('images/Logo Kemnaker.png');
  $pcuRows = $pcu->values();
...
<body>
  <div class="page">
    <div class="letter-header">
      <div class="logo-wrap">
        <img class="logo" src="{{ $logoSrc }}" alt="Logo Kementerian Ketenagakerjaan">
      </div>
    ...
    <div class="section" style="text-align:center; font-weight:700; margin-top:18px;">Memerintahkan/Menugaskan:</div>
    ...
    <div class="footer-line">
      <div class="meta">
        <div>Tgl. terbit: {{ $tanggalFooterLabel }}</div>
        <div>No. : F/7.3.1/BK3-SBY</div>
      </div>
