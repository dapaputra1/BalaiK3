...
class H2sService extends BasePrepanalisaRumusService
{
    public function __construct(
        private readonly H2sExcelReferenceService $referenceService
    ) {
    }
    ...
    public function apply(array $payload): array
    {
        ...
        $lodReference = $categorySystemCode === ServiceSystemCode::CATEGORY_LK
            ? ($reference['lodLk'] ?? [])
            : ($reference['lodAmbien'] ?? []);
