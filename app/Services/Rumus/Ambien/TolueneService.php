...
class TolueneService extends BasePrepanalisaRumusService
{
    public function __construct(
        private readonly TolueneExcelReferenceService $referenceService
    ) {
    }
    ...
    private function normalizeHasilBaca(array $dataset): array
    {
        ...
        foreach ($rows as $index => $row) {
            ...
            $result = $this->referenceService->calculateConcentration($area);
            $row['benzene'] = $this->formatDecimal($result, 5);
