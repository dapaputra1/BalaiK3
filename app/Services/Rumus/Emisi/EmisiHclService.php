...
class EmisiHclService extends BasePrepanalisaRumusService
{
    public function __construct(
        private readonly HclEmisiExcelReferenceService $referenceService
    ) {
    }
    ...
    private function normalizeCalcRow(array $row, array $lodReference): array
    {
        ...
        $calculated = $this->referenceService->calculate($kons, $vol, $fr, $waktu, $tm, $p);
