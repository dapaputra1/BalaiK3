...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasColumns('permohonans', ['status_dokumen', 'status_lab'])) {
            return;
        }
        ...
        DB::table('permohonans')
            ...
            ->each(function ($permohonan) use ($bapRows, $revisionIds) {
                ...
                $statusDokumen = $this->resolveDocumentStatus($statusGlobal, $bap, $hasRevision);
                $statusLab = $this->resolveLabStatus($statusGlobal, $statusDokumen);
