...
return new class extends Migration
{
    public function up(): void
    {
        DB::transaction(function () {
            $package = ServicePackage::query()->where('short_code', 'EMS_GENSET_6')->first();
    ...
    public function down(): void
    {
        DB::transaction(function () {
            ...
            $package->update([
                'subtitle' => 'Kapasitas 1001 - 3000 KW, Bahan Bakar Gas',
                'price' => 3000000,
            ]);

            $parameterIds = ServiceParameter::query()
                ->whereIn('short_code', ['SO22', 'COSTB', 'NO22', 'DEBU'])
                ->pluck('id', 'short_code');
